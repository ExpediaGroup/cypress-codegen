...
`);
  ...
  it("should infer type from boolean default argument", async () => {
    readFileSyncMock.mockReturnValue(`export function example(input1 = true) {
  cy.log('test');
}
`);
    const result = await generateContentsWithInterface(
    ...
    expect(result).toEqual(`export function example(input1 = true) {
  cy.log('test');
}
...
declare global {
  namespace Cypress {
    interface Chainable {
      example(input1?: boolean): Chainable;
    }
  }
}
`);
  ...
  it("should infer type from string default argument", async () => {
    readFileSyncMock.mockReturnValue(`export function example(input1 = 'hello') {
  cy.log('test');
}
`);
    const result = await generateContentsWithInterface(
    ...
    expect(result).toEqual(`export function example(input1 = 'hello') {
  cy.log('test');
}
...
declare global {
  namespace Cypress {
    interface Chainable {
      example(input1?: string): Chainable;
    }
  }
}
`);
  ...
  it("should infer type from numeric default argument", async () => {
    readFileSyncMock.mockReturnValue(`export function example(input1 = 123) {
  cy.log('test');
}
`);
    const result = await generateContentsWithInterface(
    ...
    expect(result).toEqual(`export function example(input1 = 123) {
  cy.log('test');
}
...
declare global {
  namespace Cypress {
    interface Chainable {
      example(input1?: number): Chainable;
    }
  }
}
`);
